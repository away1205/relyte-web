      ...
      <div className="max-screen mx-4 mt-[3.5rem] sm:mx-8 xl:mx-auto">
        ...
        <div className="mb-28 border-b-2 border-t-2 border-[#ccc] py-[3.5rem] sm:mb-[8.75rem] sm:py-24 xl:mb-[10.88rem] xl:py-28">
          ...
          <p className="font-b2 mt-4 sm:mt-6 sm:text-[1.75rem] xl:text-[2.5rem]">
            Relyte transformed our vision into a stunning, elegant website that
            perfectly conveys our commitment to environmental sustainability.
            They seamlessly integrated our critical data, making our message
            clear and compelling. The project was delivered quickly and
            efficiently, just in time for our investor presentation. Highly
            recommended!
          </p>

          <p className="font-b3 sm:font-b1 mt-9 text-[#888] sm:mt-12 xl:mt-[3.75rem]">
            -Arma Chaniago, Founder of Artajaya
          </p>
        </div>
      </div>
    </section>
